        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {{ html()->label(__('adminlte::users.user'), 'user_id')->class(['mb-0']) }}
                            {{
                                html()->select('user_id', $users, $selected_user)
                                ->class(['form-control', 'form-control-sm', 'is-invalid' => $errors->has('user_id')])
                                ->placeholder('- '.__('adminlte::utilities.select').' -')
                            }}
